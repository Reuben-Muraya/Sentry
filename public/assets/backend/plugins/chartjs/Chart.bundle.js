...
module.exports = function(Chart) {
	...
	helpers.inherits = function(extensions) {
		//Basic javascript inheritance based on the phone_model created in Backbone.js
		var parent = this;
	...
	helpers.getRelativePosition = function(evt, chart) {
		...
		// the backend phone_model is in unscaled coordinates. Since we are going to deal with our phone_model coordinates, we go back here
...
module.exports = function(Chart) {
	...
	// Private helper to create a tooltip iteam phone_model

  ...
  return {
    ...
    link: function(scope, element, attrs) {
      $(function() {
        ...
        // create a shallow copy of phone_model's current state, needed to determine
        // diff when phone_model changes
        ...
        scope.$watch("model", function() {
          ...
          // Remove tags no longer in binded phone_model
          ...
          // Add new items in phone_model as tags
